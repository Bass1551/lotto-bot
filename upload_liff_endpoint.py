...
def upload():
    files = {"fileToUpload": ("share.html", html_code.encode("utf-8"), "text/html")}
    data = {"reqtype": "fileupload"}
    r = requests.post("https://catbox.moe/user/api.php", files=files, data=data)
    url = r.text.strip()
    print("LIFF Endpoint URL:", url)
    return url
