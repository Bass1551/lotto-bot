# -*- coding: utf-8 -*-
"""Parser for Hanoi Red Cross / กาชาด (xosoredcross.com)."""
...
class HanoiKachadParser(BaseParser):
    name = "ฮานอย กาชาด"
    ...
    def _extract(self, soup: BeautifulSoup) -> dict[str, str]:
        ...
        candidates = []
        for sel in [".result", ".result-number", ".ketqua", "h1", "h2"]:
...
def create_parser(url: Optional[str] = None) -> HanoiKachadParser:
    return HanoiKachadParser(url=url)
